...
CMD ["/nodejs/bin/node /app/node_modules/.bin/prisma migrate resolve --rolled-back '20220621233408_hero_image_field' && /nodejs/bin/node /app/node_modules/.bin/prisma migrate deploy && /nodejs/bin/node -r /app/startup/index.js /app/node_modules/.bin/keystone start"]
